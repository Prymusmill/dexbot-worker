...
class GPTTradingAnalyzer:
    ...
    def analyze_market_signal(
            self, market_data: Dict, ml_predictions: List[Dict] = None, current_position: Dict = None) -> Dict:
    ...
    def get_performance_stats(self) -> Dict:
        ...
        success_rate = (
            ...
            self.analysis_count *
            100) if self.analysis_count > 0 else 0
...
def format_gpt_analysis_for_logging(analysis: Dict) -> str:
    ...
    short_reasoning = reasoning[:80] + \
        "..." if len(reasoning) > 80 else reasoning
    ...
    if 'key_factors' in analysis and analysis['key_factors']:
        ...
        factors = ', '.join(analysis['key_factors'][:3])
        log_message += f"\n   • Key Factors: {factors}"
